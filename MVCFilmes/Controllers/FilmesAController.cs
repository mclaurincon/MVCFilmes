...
namespace MVCFilmes.Controllers
{
    public class FilmesAController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Titulo,DatadeLancamento,Genero,Preço,Pontos")] Filmes filmes)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Titulo,DatadeLancamento,Genero,Preço,Pontos")] Filmes filmes)
        {
            if (id != filmes.Id)
            {
                return NotFound();
